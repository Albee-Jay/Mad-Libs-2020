...
function replaceIt() {
  ...
  var theStory = "<h1>Albee-Jay's Dance Party</h1>";
  theStory += "One " + adj1 + " day,";
  theStory += " Albee-Jay was " + verbIng;
  theStory += " in his " + roomInHouse;
  theStory += ", reading his book about " + color;
